...
- Obtain 2-3 certificates in R Programming and Data Processing issued by datacamp.com which you can put on your resume.
...
|-----------------------------------|------------|
| 9 Homework                        | 30%        |
| Datacamp Practice                 | 10%        |
| Exam 01                           | 15%        |
| Exam 02                           | 15%        |
| Exam 03                           | 15%        |
| In-class Participation/Class Attendance(Notes Submission)            | 10%         |
...
# Data to plot
labels = ['Homework', 'Datacamp Practice', 'Exam 1', 'Exam 2', 'Exam 3', 'In-Class Participation/Class Attendance(Notes Submission)', 'Team Problem Solving']
sizes = [30, 10, 15, 15, 15, 10, 5]  # Percentages
...
The Quantitative Reasoning and Skills Center, located in the Tiger Learning Commons of the Library, offers additional support for courses with a quantitative component. This semester, three of our tutors – **Antonio Gonzalez, Grace Etzel, and Wes Wasserburger** – are available to support students in BAT/ECON 2301 at the times listed below.  No appointment is necessary–drop in any time!
